...
RESOLVABLE = [
    ...
    ("/search/", "search"),
    ("/comments/1/new/", "comment_create"),
    ("/comments/1/more/", "comment_more"),
    ("/comments/1/reply/", "comment_reply"),
    ("/comments/1/hide/", "comment_hide"),
    ("/comments/1/unhide/", "comment_unhide"),
    ("/comments/1/like/", "comment_like"),
    ("/comments/1/edit/", "comment_edit"),
    ("/comments/1/delete/", "comment_delete"),
    ("/comments/1/pin/", "comment_pin"),
    ("/comments/1/unpin/", "comment_unpin"),
    ("/submit/", "submit"),
    ("/teams/", "team_index"),
    ("/teams/1/", "team_detail"),
